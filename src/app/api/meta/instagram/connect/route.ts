...
export async function GET(request: Request) {
  ...
  if (isMetaTargetHardBlocked(villa, "Instagram")) {
    return errorPage(`Villa Destan Instagram: HARD BLOCK. ${DESTAN_INSTAGRAM_HARD_BLOCK.reason}`, "/sosyal", 409);
  }
