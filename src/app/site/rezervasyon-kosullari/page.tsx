  ...
  return (
    <main className={styles.page}>
      ...
      <footer className={styles.footer}>
        ...
        <div className={styles.footerBottom}>{VILLAS["villa-safira"].address.addressLocality} · {VILLAS["villa-safira"].address.addressRegion} <span>safiradestan.com</span></div>
      </footer>
    </main>
  );
}
