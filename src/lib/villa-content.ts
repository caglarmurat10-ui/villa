...
//
// quickFacts (oda/banyo/kapasite yapısı): işletme sahibi tarafından 2026-09-01'de birebir doğrulandı.
// Safira: maks. 5 misafir, 2 yatak odası (1. oda: kral yatak; 2. oda: çift kişilik + tek kişilik
// yatak), ikisinde de özel banyo+WC+jakuzi, ayrıca 1 ortak WC, 1 salon, 1 mutfak, 1 çamaşır odası.
// Destan: maks. 6 misafir, 3 yatak odası — 2'si çift kişilik yataklı + özel banyo+WC+jakuzi,
// 3.'sü iki tek kişilik yataklı ve ortak banyo/WC kullanıyor; ayrıca 1 oturma odası, 1 mutfak.
// Wi-Fi, havuz ölçüsü, iptal/depozito politikası gibi başka alanlar HENÜZ DOĞRULANMADI — uydurulmadı.
//
...
export const VILLAS: Record<VillaSlug, VillaContent> = {
  "villa-safira": {
    ...
    gallery: [
      ...
      { src: "/villas/gallery/safira/safira-yatak-odasi.jpg", webp: "/villas/gallery/safira/safira-yatak-odasi.webp", alt: "Villa Safira 1. yatak odası — kral yatak, özel banyo, WC ve jakuzi", categories: ["yatak-odalari", "ozel-detaylar"], width: 1800, height: 1200 },
      { src: "/villas/gallery/safira/safira-yatak-odasi-2.jpg", webp: "/villas/gallery/safira/safira-yatak-odasi-2.webp", alt: "Villa Safira 2. yatak odası — çift kişilik ve tek kişilik yatak, özel banyo, WC ve jakuzi", categories: ["yatak-odalari", "ozel-detaylar"], width: 1800, height: 1200 },
      { src: "/villas/gallery/safira/safira-jakuzili-oda.jpg", webp: "/villas/gallery/safira/safira-jakuzili-oda.webp", alt: "Villa Safira'da bir jakuzi köşesi detayı", categories: ["ozel-detaylar"], width: 1800, height: 1200 },
    ...
    highlights: [
      ...
      { title: "2 jakuzili yatak odası", description: "Bir yatak odasında kral yatak, diğerinde çift kişilik ve tek kişilik yatak bulunur; her ikisinde de özel banyo, WC ve jakuzi vardır." },
  ...
  "villa-destan": {
    ...
    gallery: [
      ...
      { src: "/villas/gallery/destan/destan-jakuzili-yatak-odasi.jpg", webp: "/villas/gallery/destan/destan-jakuzili-yatak-odasi.webp", alt: "Villa Destan jakuzili yatak odası 1 — çift kişilik yatak, özel banyo, WC ve jakuzi", categories: ["yatak-odalari", "ozel-detaylar"], width: 1800, height: 1200 },
      { src: "/villas/gallery/destan/destan-yatak-odasi-3.jpg", webp: "/villas/gallery/destan/destan-yatak-odasi-3.webp", alt: "Villa Destan jakuzili yatak odası 2 — çift kişilik yatak, özel banyo, WC ve jakuzi", categories: ["yatak-odalari", "ozel-detaylar"], width: 1800, height: 1200 },
      { src: "/villas/gallery/destan/destan-yatak-odasi-2.jpg", webp: "/villas/gallery/destan/destan-yatak-odasi-2.webp", alt: "Villa Destan üçüncü yatak odası — iki tek kişilik yatak, ortak kullanım banyo/WC", categories: ["yatak-odalari"], width: 1800, height: 1200 },
    ...
    highlights: [
      ...
      { title: "2 jakuzili yatak odası", description: "İki yatak odasında çift kişilik yatak, özel banyo, WC ve jakuzi bulunur." },
      { title: "İkiz yataklı oda", description: "Üçüncü yatak odasında iki tek kişilik yatak vardır; ortak banyo ve WC kullanılır." },
      { title: "Donanımlı mutfak", description: "Ankastre ocak, fırın ve bulaşık makinesiyle tam donanımlı mutfak." },
    ...
    // Kullanıcı tarafından 2026-09-01'de doğrulandı - public rezervasyon CTA linki (OTA takvim
    // senkronundaki gizli ICS export URL'siyle karıştırılmamalı, bu tamamen ayrı/public bir link).
    airbnbListingUrl: "https://www.airbnb.com/rooms/51842201",
  },
};
